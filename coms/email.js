...
module.exports = class Email {
   ...
   static rmaiReset(xxemail, newRandomPword) {
    ...
    var mailOptions = {
	  ...
	  html: '<html><head><link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"></head><body class="w3-light-grey">  <header class="w3-container w3-center w3-padding-48 w3-white"><h1 class="w3-xxxlarge"><b><a href="https://www.1of1.ie" style="text-decoration: none;">1OF1.IE</a></b></h1><h6>Research <span class="w3-tag">Agency</span></h6></header><header class="w3-display-container w3-wide" id="home"><img class="w3-image" src="https://www.win.ie/images/fullvictory.jpg" alt="research is everything" width="1600" height="1060"><div class="w3-display-left w3-padding-large"><h1 class="w3-text-white">Reset Email Request</h1></div></header> <div class="w3-container w3-white w3-margin w3-padding-large"><div class="w3-justify"> <div class="w3-white w3-margin"> <div class="w3-container w3-padding w3-black"><h4>What Next?</h4></div><div class="w3-container w3-large w3-padding"><p>As you have requested a reset password for 1of1.ie we have reset it for you. Your temporary password is ' + newRandomPword + ' We recommend you change this through your profile when you log back in here <a href="https://www.1of1.ie/login" style="text-decoration: none;">AAAGGGH.COM</a>.</p><p>If you did not request this email please reply immediately to this email and inform us what happened. Also immediately go to our website and reset your password again, Thank you for using <a href = "https://1of1.ie" style="text-decoration:none;">1of1.ie</a></p></div></div></div></div><footer class="w3-container w3-dark-grey" style="padding:32px"><div class="w3-row "> <div class="w3-center"><p>Thank You, The 1of1.ie Team</p></div></div></footer></body></html>'
    };
